...
desc 'Generate documentation for the options_ordering extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'OptionsOrderingExtension'
...
desc 'Test the options_ordering extension.'
...
namespace :test do
  desc 'Functional test the options_ordering extension.'
  ...
  desc 'Unit test the options_ordering extension.'
